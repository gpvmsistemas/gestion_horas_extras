...
// ── 14b · Suscripciones Web Push (PWA de Lautaro) ────────────────────────────
// Su migración original usaba utf8mb4_unicode_ci; acá se crea directamente en
// general_ci para respetar la colación unificada (el paso 15 normaliza si ya
// existía con otra).
$paso('push_subscriptions (Web Push / PWA)',
    fn() => $hasTab('push_subscriptions'),
    fn() => $pdo->exec("CREATE TABLE IF NOT EXISTS push_subscriptions (
