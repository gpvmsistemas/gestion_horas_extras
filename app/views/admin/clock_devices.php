...
<div class="row g-4 clock-devices-layout">
    ...
    <div class="col-xl-4"><section class="admin-surface clock-device-form-panel">
        ...
        <div class="admin-surface-body"><form method="post" action="<?php echo URLROOT; ?>/admin/saveClockDevice">
            ...
            <div class="mb-3"><label class="form-label">Nombre visible</label><input class="form-control" name="display_name" placeholder="Ej. Reloj <?php echo function_exists('org_is_moderna') && org_is_moderna() ? 'Farmacia Moderna 1' : 'Ecofarma Central'; ?>"></div>
