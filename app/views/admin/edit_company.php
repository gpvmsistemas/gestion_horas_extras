                        ...
                        <div class="edit-company-section-body"><div id="branchesList" class="vstack gap-3">
                            ...
                            <div class="branch-row">
                                ...
                                <div class="row g-2 align-items-end">
                                    <div class="col-md-4"><label class="form-label small">Sucursal</label><input type="text" class="form-control" name="branches[<?php echo (int)$index; ?>][name]" value="<?php echo htmlspecialchars($branch->name); ?>" placeholder="Ej. <?php echo function_exists('org_is_moderna') && org_is_moderna() ? 'Farmacia Moderna 1' : 'Ecofarma Central'; ?>"></div>
